    ...
    val listData: ArrayList<Destination>
        get() {
            ...
            for (position in destinationName.indices) {
                ...
                hero.favorite = destiFavorite[position]
                hero.circle = btnCircleGrid[position]
